...
import com.chichi.todocompose.components.DisplayAlertDialog
import com.chichi.todocompose.components.PriorityItem
import com.chichi.todocompose.data.models.Priority
import com.chichi.todocompose.ui.theme.*
...
fun DeleteAllAction(
    ...
    IconButton(onClick = {
        ...
        Icon(
            painter = painterResource(id = R.drawable.ic_verticle_menu),
